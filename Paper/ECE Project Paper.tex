...
\textbf{Training duration.} The limited number of epochs used in our testing affected our lack of meaningful results on LunarLander-v3, thus reflect mid-training behavior rather than final performance.
...
Results on Acrobot-v1 and LunarLander-v3 are inconclusive, reflecting limitations in training duration rather than the method itself, proving that clipping works best in stress-based environments. Future work should extend training to more epochs and evaluate on continuous-action environments to more directly replicate the conditions of the original paper.
...
ChatGPT was used during the preparation of this manuscript for the following purposes: (1) suggesting structural edits such as condensing the introduction; (2) editing prose for better grammar structure
